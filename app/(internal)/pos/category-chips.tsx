...
// Chip kategori yang bisa di-drag untuk reorder, tampil dalam flex-wrap.
// Tidak ada horizontal scroll — chip membungkus ke baris baru secara otomatis.
  ...
  return (
    ...
    >
      <div className="flex flex-wrap gap-1.5">
        <Chip label="Semua" active={active === null} onClick={() => onChange(null)} />
  ...
  return (
    <button
      ...
      className={`whitespace-nowrap rounded-full px-4 py-1.5 text-sm font-semibold transition ${
        active ? "bg-brand text-white" : "border border-hairline bg-white text-ink"
      }`}
    >
      {label}
    </button>
  ...
  return (
    <div
      ...
      className={`flex items-center gap-1 rounded-full border transition ${
        active ? "border-brand bg-brand text-white" : "border-hairline bg-white text-ink"
